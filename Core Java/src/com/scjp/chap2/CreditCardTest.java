...
public class CreditCardTest {
	public static void main(String[] args) {
		...
		if (creditCard.equals(AllowedCreditCard.VISA.getName())) {
			...
			System.out.println("Your credit card " + args[0] + " is accepted.");
		} else if (creditCard.equals(AllowedCreditCard.AMERICAN_EXPRESS
				.getName())) {
			System.out.println("Your credit card " + args[0] + " is accepted.");
		} else {
...
class AllowedCreditCard {
	...
	public final static AllowedCreditCard MASTER_CARD = new AllowedCreditCard(
			"MASTER_CARD");
	public final static AllowedCreditCard AMERICAN_EXPRESS = new AllowedCreditCard(
			"AMERICAN_EXPRESS");
